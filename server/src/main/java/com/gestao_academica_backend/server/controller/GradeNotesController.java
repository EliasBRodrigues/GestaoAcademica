...
public class GradeNotesController {
    ...
    @GetMapping("/api/grades/student/notes/{email}")
    public ResponseEntity<?> getGradesNotesByStudentEmail(@PathVariable String email) throws Exception{
        return ResponseEntity.ok(gradeNotesServiceImpl.findGradeNotesByStudentEmail(email));
    }
